    ...
    frontends:
      fe_http_gs_in:
        ...
        use_backend:
          ...
          - '"%[req.hdr(host),lower,map_sub(/etc/haproxy/hostmap/game.map)]" if gs_sub gs_domain gs_path || gs_sub gs_domain alive_path 5g_offcie_ip'        
